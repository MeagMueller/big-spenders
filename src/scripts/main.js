const businesses = [
    {
      ...
      orders: [10000, 7826.96, 8323.11, 5756.28, 6308.42, 5622.28],
...
const bigSpenders = businesses.filter(business => {
    return business.orders.find(meow => {  
        return meow >= 9000
    })

})

bigSpenders.forEach(eachCompany => {
    const bigSpendersOnDom = document.createElement("div")
    bigSpendersOnDom.textContent += `${eachCompany.companyName}`
    display.appendChild(bigSpendersOnDom)
})